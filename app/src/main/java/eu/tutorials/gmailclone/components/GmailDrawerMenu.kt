package eu.tutorials.gmailclone.components
...
import eu.tutorials.gmailclone.DrawerMenuData
    ...
    Column(Modifier.verticalScroll(scrollState)){
        ...
        menuList.forEach { 
            ...
            when {
                ...
                item.isHeader ->{
                    Text(text = item.title!!, fontWeight = FontWeight.Light, modifier = Modifier.padding(start = 20.dp, top=20.dp, bottom = 20.dp))
                }else ->{
